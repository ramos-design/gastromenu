...
export const initialDishes: Dish[] = [
  ...
  {
    id: '6',
    name_cz: 'Smažený sýr s hranolkami a tatarskou omáčkou',
    name_en: 'Fried cheese with french fries and tartar sauce',
    price: 180,
    type: 'Hlavní jídlo',
    allergenIds: [1, 3, 7, 10],
  },
  {
    id: '7',
    name_cz: 'Pečená vepřová krkovice, dušené zelí, houskový knedlík',
    name_en: 'Roast pork neck, stewed cabbage, bread dumpling',
    price: 230,
    type: 'Hlavní jídlo',
    allergenIds: [1, 12],
  },
  {
    id: '8',
    name_cz: 'Rajská omáčka s hovězím masem a těstovinami',
    name_en: 'Tomato sauce with beef and pasta',
    price: 210,
    type: 'Hlavní jídlo',
    allergenIds: [1, 9],
  },
